...
public class SaltwaterFluidType extends FluidType {
	public SaltwaterFluidType() {
		super(FluidType.Properties.create().fallDistanceModifier(0F).canExtinguish(true).supportsBoating(true).canHydrate(true).motionScale(0.007D).density(1200).viscosity(2000).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL)
