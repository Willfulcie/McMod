...
public class TestMod {
	...
	public TestMod(IEventBus modEventBus) {
		...
		TestModBlocks.REGISTRY.register(modEventBus);

		TestModItems.REGISTRY.register(modEventBus);
		TestModEntities.REGISTRY.register(modEventBus);
		TestModTabs.REGISTRY.register(modEventBus);

		TestModFluids.REGISTRY.register(modEventBus);
		TestModFluidTypes.REGISTRY.register(modEventBus);
