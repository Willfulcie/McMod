...
public class SodiumSwordWaterExplodeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (isInWaterRainOrBubble(entity) || entity.isUnderWater()) {
			...
			explode_level = new ItemStack(TestModItems.SODIUM_SWORD.get()).getMaxDamage();
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(TestModItems.SODIUM_SWORD.get());
